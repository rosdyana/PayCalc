                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="tg-yw4l" colspan="2">
                                        <div class="form-group">
                                            <input class="form-control"
                                            disabled id="totalTaxComponent_field" name=
