				...
				<tbody>
					...
					<tr>
						<td class="tg-yw4l">
							...
							<table class="tg" id="SecondGroup" width="75%">
								<tbody>
									<tr>
										<td class="tg-031e">Total Severance</td>
										<td class="tg-031e">
											<div class="form-group">
												<input class="form-control" id="totalSeverance_field" name="totalSeverance_field" style="width:98%">
											</div>
										</td>
										<td class="td-none" colspan="1" rowspan="2">
											<center>
												<input class="calculate-button" id="hitung_button" name="hitung_button" onclick="calculate_severance();" style="height:60px;width:80px" type="button" value="Calculate">
											</center>
										</td>
									</tr>
									<tr>
										<td class="tg-031e">Severance Tax</td>
										<td class="tg-031e">
											<div class="form-group">
												<input class="form-control" id="SeveranceTax_field" name="SeveranceTax_field" style="width:98%">
											</div>
										</td>
									</tr>
								</tbody>
